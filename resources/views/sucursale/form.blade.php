<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('cant_empleados', $sucursale->cant_empleados, ['class' => 'form-control' . ($errors->has('cant_empleados') ? ' is-invalid' : ''), 'placeholder' => 'Cant Empleados']) }}
            {!! $errors->first('cant_empleados', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('empleado_id') }}
            {{ Form::text('empleado_id', $sucursale->empleado_id, ['class' => 'form-control' . ($errors->has('empleado_id') ? ' is-invalid' : ''), 'placeholder' => 'Empleado Id']) }}
